...
耳機：「但因為你的焦慮還沒完全消除，所以你必須在擊倒更多焦慮，才有機會回到現實世界」#speaker:耳機#portrait:default#layout:right

耳機：「怪物掉落的是『對話碎片』，在你在心理世界時現實世界還是在流動，對話碎片是你暫時擊敗焦慮時聽到的現實世界的聲音，也是你成長的證明，可以讓你在心理世界的能力提升」#speaker:耳機#portrait:default#layout:right

耳機：「靠近後按下 E 可以拾取」#speaker:耳機#portrait:default#layout:right
